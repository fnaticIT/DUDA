...
const Forms = () => {
  ...
  const submitForm = async (e) => {
    ...
    if (name.current.value === '' || email.current.value === '' || phone.current.value === '' || college.current.value === '' || by.current.value === '' || topic.current.value === '' || desc.current.value === '') {
      console.log("incorrect");
      window.alert("Please fill all the fields");
      return;
    }
    console.log(form);
    await axios.post("https://duda-dbs.herokuapp.com/form", form);
